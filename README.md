...
- **`daemon.log` records your message text verbatim.** Every chat message is written in plaintext to `~/.claude/office-addins/daemon.log` (tray → Open logs). Treat it as sensitive; delete it to scrub history.
